...
// --- REAL DATA FOR WEST BENGAL (294 SEATS - First 50 + Generic) ---
const WEST_BENGAL_DATA = [
  { no: 1, name: "Mekliganj (SC)" }, { no: 2, name: "Mathabhanga (SC)" }, { no: 3, name: "Cooch Behar Uttar (SC)" }, { no: 4, name: "Cooch Behar Dakshin" }, { no: 5, name: "Sitalkuchi (SC)" }, { no: 6, name: "Sitai (SC)" }, { no: 7, name: "Dinhata" }, { no: 8, name: "Natabari" }, { no: 9, name: "Tufanganj" }, { no: 10, name: "Kumargram (ST)" }, { no: 11, name: "Kalchini (ST)" }, { no: 12, name: "Alipurduars" }, { no: 13, name: "Falakata (SC)" }, { no: 14, name: "Madarihat (ST)" }, { no: 15, name: "Dhupguri (SC)" }, { no: 16, name: "Maynaguri (SC)" }, { no: 17, name: "Jalpaiguri (SC)" }, { no: 18, name: "Rajganj (SC)" }, { no: 19, name: "Dabgram-Phulbari" }, { no: 20, name: "Mal (ST)" }, { no: 21, name: "Nagrakata (ST)" }, { no: 22, name: "Kalimpong" }, { no: 23, name: "Darjeeling" }, { no: 24, name: "Kurseong" }, { no: 25, name: "Matigara-Naxalbari (SC)" }, { no: 26, name: "Siliguri" }, { no: 27, name: "Phansidewa (ST)" }, { no: 28, name: "Chopra" }, { no: 29, name: "Islampur" }, { no: 30, name: "Goalpokhar" }, { no: 31, name: "Chakulia" }, { no: 32, name: "Karandighi" }, { no: 33, name: "Hemtabad (SC)" }, { no: 34, name: "Kaliaganj (SC)" }, { no: 35, name: "Raiganj" }, { no: 36, name: "Itahar" }, { no: 37, name: "Kushmandi (SC)" }, { no: 38, name: "Kumarganj" }, { no: 39, name: "Balurghat" }, { no: 40, name: "Tapan (ST)" }, { no: 41, name: "Gangarampur (SC)" }, { no: 42, name: "Harirampur" }, { no: 43, name: "Habibpur (ST)" }, { no: 44, name: "Gazole (SC)" }, { no: 45, name: "Chanchal" }, { no: 46, name: "Harishchandrapur" }, { no: 47, name: "Malatipur" }, { no: 48, name: "Ratua" }, { no: 49, name: "Manikchak" }, { no: 50, name: "Maldaha (SC)" }
];
...
const generateConstituencies = (stateCode: string, totalSeats: number): AssemblyConstituency[] => {
  ...
  const genericFallback = (startFrom: number) => {
    ...
    for (let i = startFrom; i <= totalSeats; i++) {
      list.push({
        ...
        number: i,
        name: `${stateCode} Segment ${i} (Data Ready)`,
  ...
  if (stateCode === 'WB') return [...mapData(WEST_BENGAL_DATA, "West Bengal"), ...genericFallback(51)];
